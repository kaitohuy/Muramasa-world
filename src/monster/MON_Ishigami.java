...
public class MON_Ishigami extends Monster{
	...
	public void setDialogue() {
	    ...
	    dialogues[0][0] = localize(
	        "Ishigami: Chào mừng ngươi bước vào trận chiến tranh\nngôi vương!",
	        "Ishigami: Welcome to the battle\nfor the throne!"
	    );
	    dialogues[0][1] = localize(
	        "Ishigami: Không ngờ ta lại có thể giết ngươi thêm một\nlần nữa!",
	        "Ishigami: Never thought I'd get to\nkill you once more!"
	    );
	    dialogues[0][2] = localize(
	        "Ishigami: Đừng nghĩ rằng chỉ có mình ngươi là mạnh lên,\nta sẽ cho ngươi nếm thử sức mạnh mới của ta!",
	        "Ishigami: Don’t think only you’ve\ngrown stronger — feel my\nnew power!"
	    );
	    dialogues[0][3] = localize(
	        "Ishigami: Đây sẽ là trận chiến của riêng hai ta, con\nGriffon đi theo ngươi vốn do ta tạo ra.",
	        "Ishigami: This will be between us!\nThat Griffon you follow was\nmy creation."
	    );
	    dialogues[0][4] = localize(
	        "Ishigami: Nhiệm vụ dẫn hắn đến đây đã hoàn thành, đến\nlúc ngươi biến mất được rồi đó!",
	        "Ishigami: Its task is done — now it’s\ntime for you to vanish!"
	    );
	
	    // Phase 2 – khi biến hình
	    dialogues[1][0] = localize(
	        "Ishigami: Ta công nhận ngươi thật sự rất mạnh, ta không\nnhớ đã bao lâu rồi mới phải dùng đến hình dạng này nữa.",
	        "Ishigami: I admit, you’re truly strong.\nIt’s been ages since I last\nused this form."
	    );
	    dialogues[1][1] = localize(
	        "Ishigami: Dù hôm nay ngươi có chết cũng đừng nản chí,\nhiếm ai khiến ta ra nông nỗi này được.",
	        "Ishigami: Even if you die today,\ndon’t despair — few ever\npush me this far."
	    );
	    dialogues[1][2] = localize(
	        "Ishigami: Hãy tiếp tục trận chiến nào! Ta sẽ không nương\ntay nữa, đến lúc cho ngươi thấy chiêu thức ta đã tu\nluyện suốt thời gian qua rồi!",
	        "Ishigami: Let’s continue! No more\nmercy — behold the spell I’ve\nhoned for ages!"
	    );
	}
