...
public class NPC_Mage_Red extends Entity{
	...
	public void setDialogue() {
		...
		if (gp.config.lang == main.Lang.EN) {
		    ...
		    i = 0;
		    dialogues[0][i] = "Mage: Long time no see. I wonder who now resides\nwithin you?"; i++;
		    dialogues[0][i] = "Mage: After that battle, this body still remembers\nthe fear of my demon lord’s power."; i++;
		    dialogues[0][i] = "Mage: Yet now you return with a completely\ndifferent aura. I wonder if history will repeat\nitself this time."; i++;
		    dialogues[0][i] = "Mage: I have dwelled here since the dawn of all\nthings. My duty is to serve the strongest—the\nking of this world."; i++;
		    dialogues[0][i] = "Mage: If you triumph, I shall become your servant\nand open the gate to your world."; i++;
		    dialogues[0][i] = "Mage: I shall reveal one secret—as a reward for\nmaking it this far."; i++;
		    dialogues[0][i] = "Mage: It’s said he is mastering condensed time\nmagic. If it hits, your body will freeze\ncompletely."; i++;
		    dialogues[0][i] = "Mage: Do not approach too closely, or you’ll look\nlike a training dummy for his spells."; i++;
		    dialogues[0][i] = "Mage: Let’s see if today the throne will change\nhands. Step forward and conquer this trial!\nHahahahah..."; i++;
		} else {
		    i=0;
