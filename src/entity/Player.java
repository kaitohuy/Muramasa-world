...
public class Player extends Entity {
	...
	public void setDialogue() {
		if (gp.config.lang == main.Lang.EN) {
		    dialogues[0][0] = "You have reached level " + level + "!\nA surge of power flows through your veins!";
		    dialogues[1][0] = "You must reach level 3 or higher to use\nthis skill!";
		    dialogues[2][0] = "You must reach level 5 or higher to use\nthis skill!";
		    dialogues[3][0] = "You need to learn how to summon Phoenix\nthrough the instruction book!";
		} else {
