...
public class NPC_Merchant extends Entity{
	...
	public void setDialogue() {
		if (gp.config.lang == main.Lang.EN) {
		    dialogues[0][0] = "My clan’s mission is to forge weapons and items\nto destroy demons. Of course, everything has its\nprice. Are you here to buy or sell?";
		    dialogues[1][0] = "Farewell, may you fulfill your destiny!";
		    dialogues[2][0] = "Broke yet still buying? Go earn some money\noutside first!";
		    dialogues[3][0] = "Your inventory is full—drop a few things before\nbuying more!";
		    dialogues[4][0] = "You can’t sell an item you’re currently using.\nUnequip it first!";
