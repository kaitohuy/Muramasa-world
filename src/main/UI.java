...
public class UI {
	...
	private String tr(String vi, String en) {
	    return (gp.config.lang == Lang.EN) ? en : vi;
	}
	...
	public void options_top(int frameX, int frameY) {
		...
		//title
		String text = tr("Tuỳ chọn", "Options");
		...
		textY += gp.tileSize*2;
		g2.drawString(tr("Toàn màn hình", "Full Screen"), textX, textY);
		if(commandNum == 0) {
		...
		textY += gp.tileSize;
		g2.drawString(tr("Ngôn ngữ", "Language"), textX, textY);
		if (commandNum == 1) {
	        g2.drawString(">", textX - 24, textY);
	        if (gp.keyH.enterPressed) {
	            gp.config.lang = (gp.config.lang == Lang.VI ? Lang.EN : Lang.VI);
	            gp.applyLanguage();
	        }
	    }
		...
		//music
		textY += gp.tileSize;
		g2.drawString(tr("Nhạc nền", "Music"), textX, textY);
		if(commandNum == 2) {
			g2.drawString(">", textX - 24, textY);
		}
		...
		//SE
		textY += gp.tileSize;
		g2.drawString(tr("Hiệu ứng âm", "Sound Effect"), textX, textY);
		if(commandNum == 3) {
			g2.drawString(">", textX - 24, textY);
		}
		...
		// Language checkboxes (VI / EN)
	    textY = frameY + gp.tileSize*3 + 24;
	    if (gp.config.lang == Lang.VI) {
	    	g2.drawString("VI", textX+48, textY+24);
		    g2.drawRect(textX, textY, 24, 24);
	    	g2.fillRect(textX, textY, 24, 24);
	    }
	    if (gp.config.lang == Lang.EN) {
	    	g2.drawString("EN", textX + 48, textY+24);
		    g2.drawRect(textX, textY, 24, 24);	    	
		    g2.fillRect(textX, textY, 24, 24);
	    }
